"""
Django settings for entrini_backend project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-!yvnw+vixft^wzg6-9wjs2el&=&j=3@w%7j@91$6dzxwz*4_)4')
...
ROOT_URLCONF = 'entrini_backend.urls'
...
WSGI_APPLICATION = 'entrini_backend.wsgi.application'
